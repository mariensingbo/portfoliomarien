...
export default class Media {
  ...
  createProgram() {
    this.program = new Program(this.gl, {
      ...
      vertex,
      uniforms: {
        uAlpha: { value: 0 }, // Set the initial value of uAlpha to 0
        uSpeed: { value: 0 },
...
setUpClickAnimation() {
    document.addEventListener("pointerdown", this.show.bind(this));
    document.addEventListener("pointerup", this.hide.bind(this));
    document.addEventListener("pointercancel", this.hide.bind(this));
}
